	...
	override public function create()
	{
		...
		if(PlayState.SONG.stage == null || PlayState.SONG.stage.length < 1) {
			switch (songName)
			{
				...
				case 'thorns':
					curStage = 'schoolEvil';
				case 'snowed-in' | 'beeping-start' | 'spooky-scary':
					curStage = 'snowdin';
				case 'know-the-deal':
					curStage = 'snowdin-night';
				default:
					curStage = 'stage';
			}
		}
		...
		switch (curStage)
		{
			...
			case 'snowdin': //Week 1
				var bg:BGSprite = new BGSprite('sasn/bgsansnight', -350, -100, 0.9, 0.9);
				add(bg);
				
			case 'snowdin-night': //Week 1
				var bg:BGSprite = new BGSprite('sasn/bgsansnightmad', -350, -100, 0.9, 0.9);
				add(bg);
		...
		healthBarBG.screenCenter(X); //TP 2
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'Text': //TELEPORT
				...
				var dia:FlxSprite;
				dia = new FlxSprite(0, 200);
				dia.frames = Paths.getSparrowAtlas('sasn/dialogue');
				add(dia);
				dia.animation.addByPrefix('open', 'dialogue1', 30, false);
				dia.visible = false;
				dia.screenCenter(X);
			...
			case 'Text2': //TELEPORT
				...
				var dia2:FlxSprite;
				dia2 = new FlxSprite(0, 200);
				dia2.frames = Paths.getSparrowAtlas('sasn/dialogue2');
				add(dia2);
				dia2.animation.addByPrefix('open', 'dialogue2', 30, false);
				dia2.visible = false;
				dia2.screenCenter(X);
		        dia2.scrollFactor.set();
				dia2.cameras = [camHUD];
				dia2.x += 15;
		        dia2.y += 230;
			...
			case 'Text3': //TELEPORT
				...
				var dia3:FlxSprite;
				dia3 = new FlxSprite(0, 200);
				dia3.frames = Paths.getSparrowAtlas('sasn/dialogue3');
				add(dia3);
				dia3.animation.addByPrefix('open', 'dialogue3', 30, false);
				dia3.visible = false;
				dia3.screenCenter(X);
		        dia3.scrollFactor.set();
				dia3.cameras = [camHUD];
				dia3.x += 20;
		        dia3.y += 230;
